...
class Developer {
  ...
  final List<String> passion = ["Game Dev", "Mobile App", "Clean Architecture"];
  final String motto  = "Code every day, grow every day 🚀";

  Map<String, dynamic> currentFocus() => {
    "🎮 Unity":   "3D/2D Game Development with C#",
    "📱 Flutter": "Cross-platform Mobile App with Dart",
    "🔥 Goal":    "Shipping products that make a difference",
  };
}
```
...
| 🎮 Unity Projects | 📱 Flutter Projects |
|:---:|:---:|
| 3D / 2D Game Development | Cross-platform Mobile Apps |
| C# Game Logic & Systems | Clean Architecture (MVVM) |
| Physics & Animation | Firebase Integration |
| AR/VR Experiences | Custom UI/UX Design |
